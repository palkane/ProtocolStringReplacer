...
dependencies {
    ...
    implementation(project(":embedded-protocol"))
...
tasks {
    shadowJar {
        ...
        relocate("net.bytebuddy", "io.github.rothes.protocolstringreplacer.lib.net.bytebuddy")
        relocate("com.comphenix.protocol", "io.github.rothes.protocolstringreplacer.lib.protocol")

        exclude("com/comphenix/protocol/ProtocolLib.class")
        exclude("com/comphenix/protocol/Command*.class")
        exclude("com/comphenix/protocol/PacketLogging*.class")
        exclude("com/comphenix/protocol/MultipleLinesPrompt*.class")
        exclude("com/comphenix/protocol/metrics/**")
        exclude("com/comphenix/protocol/updater/**")

        minimize {
            exclude(project(":bukkit:nms"))
            exclude(dependency("commons-collections:commons-collections:.*"))
            exclude(dependency("org.neosearch.stringsearcher:multiple-string-searcher:.*"))
